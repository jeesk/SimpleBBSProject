				...
				<tbody>
					<tr>
						...
						<td class="jive-icon-label"><a id="jive-reply-thread"
							href="${pageContext.request.contextPath}/list?method=reply&id=${articles[0].id}&rootid=${articles[0].rootid}">回复本主题</a>
						</td>
					</tr>
				</tbody>
			</table>
								...
								<div class="jive-table">
									...
									<c:forEach items="${articles}" var="s" varStatus="vs">
										...
										<table summary="Message" border="0" cellpadding="0"
											...
											<tbody>
												<tr id="jive-message-780144" class="${vs.count%2==0 ? 'jive-odd':'jive-even'} " valign="top">
																				...
																				<tbody>
																					<tr>
																						...
																						<td class="jive-icon-label"><a
																							href="${pageContext.request.contextPath}/list?method=reply&id=${s.id}&rootid=${s.rootid}"
																							title="回复本主题">回复</a></td>
																					</tr>
																				</tbody>
																			</table>
